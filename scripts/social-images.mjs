...
const cards = {
  ...
  "/newsletter/": { title: "Build more with AI.\nAutomate the busywork.", label: "ADRIAN CHING'S NEWSLETTER", action: "Get the free emails →", description: "Practical ideas for using AI and automation, plus a look inside the businesses Adrian Ching is building: the tools, decisions, mistakes and lessons along the way.", photo: "reading", y: 100 },
